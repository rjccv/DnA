...
# Model name
_C.MODEL.MODEL_NAME = "vit_base_patch16_224"
...
_C.TIMESFORMER.DNA_ATTENTION_TYPE = 'dna'
_C.TIMESFORMER.PRETRAINED_MODEL = ''
_C.TIMESFORMER.PRETRAINED_CONVERT = False
_C.TIMESFORMER.PRETRAINED_Q_NEG_SCALE = 1e-4
_C.TIMESFORMER.PRETRAINED_V_NEG_SCALE = -1e-4
_C.TIMESFORMER.PRETRAINED_USE_PCA = True
...
# Optional directory containing Smarthome split files (train/val/test).
# If empty, Smarthome uses DATA.PATH_TO_DATA_DIR.
_C.DATA.SMARTHOME_SPLIT_DIR = ""
...
# Accuracy aggregation mode for classification.
# "sample": micro accuracy (correct / total samples).
# "mean_class": macro accuracy (average of per-class recalls).
_C.METRICS.ACCURACY = "mean_class"
...
def _assert_and_infer_cfg(cfg):
    ...
    assert cfg.METRICS.ACCURACY in ["sample", "mean_class"]
