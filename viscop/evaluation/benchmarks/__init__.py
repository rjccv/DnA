...
from .egoperceptionmcq import EgoExo4DDataset, EgoExo4DDataset_Depth
from .adlx_mcq import ADLX_MCQ
from .adlx_desc import ADLX_Descriptions

DATASET_REGISTRY = {
    "adlx_mcq": ADLX_MCQ,
    "adlx_descriptions": ADLX_Descriptions,
    "egoperceptionmcq": EgoExo4DDataset,
    "egoperceptionmcq_depth": EgoExo4DDataset_Depth,
